function TodoList() {
    ...
    const handleToggleFinished = async (todoId) => {
    ...
    return (<Container>
        ...
        <StyledTable>
            <thead>
            <tr>
                <TableCell header width={'200px'}>Title</TableCell>
                ...
                <TableCell header center>Actions</TableCell>
            </tr>
            </thead>
            <tbody>
            {todos
                .filter(todo => !hideCompleted || !todo.finished)
                .map(todo => (<tr key={todo.todoId} style={{backgroundColor: todo.finished ? '#eaffea' : '#fff'}}>
